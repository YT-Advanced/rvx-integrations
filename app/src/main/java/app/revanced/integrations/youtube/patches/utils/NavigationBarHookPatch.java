...
import static app.revanced.integrations.youtube.patches.utils.NavigationBarHookPatch.NavigationButton.CREATE;

@SuppressWarnings("unused")
public final class NavigationBarHookPatch {
        ...
        try {
            ...
            for (NavigationButton button : NavigationButton.values()) {
                if (button.ytEnumName.equals(lastEnumName)) {
                    ImageView imageView = ReVancedUtils.getChildView((ViewGroup) navigationButtonGroup,
            ...
            LogHelper.printDebug(() -> "Unknown tab: " + lastEnumName
